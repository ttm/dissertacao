...
Outra possibilidade é usar o último filtro que desta
coleção: o biquad\footnote{Abreviação
...
Existem diversas receitas para esta classe de filtro e
recomendamos ~\ref{music-dsp} por possuir as 4 funcionalidades da figura \ref{fig:iir}.
