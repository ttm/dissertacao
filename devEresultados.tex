...
\begin{equation}
    R_i=\left\{r_i\right\}_0^{\Lambda_R-1}\;:\;r_i=\left\{
        \begin{array}{l l}
            r_i^1\;  & \text{se }\quad i<\Lambda_1-1 \\
