...
recursos como este e variações da forma de onda da oscilação com vínculos, de modo a formar um \emph{idioma musical}\footnote{Veja na próxima seção.}. Seu código está no Apêndice~\ref{ap:tremolos} e também disponivel online como parte da caixa de ferramentas \massa.
...
claros e quantitativos (seção~\ref{notaBasica}). Em seguida, a nota foi adentrada e foram compreendidas suas transições internas e de tratamentos imediatos (seção~\ref{varInternas}). Por fim, esta última seção dedica-se a organizar estas notas musicais em música.
