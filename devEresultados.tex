...
compreende durações entre $0,25-1,5s$ ($40-240BPM$). Na educação musical e estudos cognitivistas,
costuma-se associar esta gama de velocidade de pulsação às durações entre batidas 
do coração ou entre os passos ao caminhar.



O pulso é subdividido em partes iguais e também é 
repetido sequencialmente (veja a figura ~\ref{fig:pulsoSubAgl}. Estas relações (de divisão e de concatenação) costumam
...
e então 8 (2 grupos de 4), 9 (3 grupos de 3) e por 
...
Nos tempos binários, os tempos fortes são
