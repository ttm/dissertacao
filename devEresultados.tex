...
Desta forma, podemos calcular os elementos $t_i^{\overline{f_0,f_{\Lambda-1}}}$ com base no período $\{\widetilde{l}_i\}_0^{\Lambda-1}$.
...
\emph{percebida} como linear segue a progressão logarítmica:
