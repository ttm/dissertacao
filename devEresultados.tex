...
\begin{figure}[h!]
    ...
    \caption{Formas de onda básicas em 4 amostras}
        \includegraphics[width=\textwidth]{figuras/amostras4formas_}
        \label{fig:formas4}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption{Formas de onda básicas em 6 amostras}
        \includegraphics[width=\textwidth]{figuras/amostras6formas__}
        \label{fig:formas6}
\end{figure}
...
\section{Variações da nota musical básica}
