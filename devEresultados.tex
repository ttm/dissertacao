...
Sendo cada unidade um semitom. Ou seja, cada unidade é o fato que fica presente na conta $f_0 . 2^(1/12) . fator $ e resulta na frequência exata da nota em um sistema temperado ideal.

Claro que podemos também utilizar as usuais
...
que são partes proporcionais dos semitons:
