...
não são absolutamente fixos.\cite{Chowning} Por exemplo, uma nota de piano
...
e a complexidade da nossa cognição sonora. Desta forma, serão apontados
recursos primários para estas variações das características na nota
básica.

Todas as relações descritas nesta seção estão no Apêndice~\ref{sec:cod2}
...
Para nós, entretanto, a mais facilmente controlada é de fato a energia da onda (veja equação~\ref{eq:potencia}) e esta também pode variar de diferentes formas.
