...
musicais. Por simplicidade, sejam notas estes eventos musicais
e seja $S_j$ chamada uma 'estrutura musical'. Esta seção é dedicada às técnicas
...
\subsection{Motivos e unidades maiores}\label{subsec:motivos}
