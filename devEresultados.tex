...
e pertinente o suficiente para ter gerado ampla bibliografia e um histórico
que remonta desde a própria história da computação e das linguagens de programação.
Desta forma, entendemos razoável abordar as empreitadas realizadas pelos autores
da presente dissertação, com foco nas realizações do primeiro autor. 

De forma satisfatória, tais realizações possuem um espectro amplo
...
Por razões didáticas, dividimos este capítulo em 5 partes, a saber: experimentos
...
música em tempo real,  música na matéria (suporte físico em hardware) e música no espírito
...
[imagens da AHT e dos patches em operação]
   ...
   \subsection{Música no Espírito: Sabrina Kawahara, Audioexperiments, EstudioLivre.org, CDTL, juntaDados.org, Devolts.org, MSST, LabMacambira.sf.net}
