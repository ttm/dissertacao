...
Nossa percepção segue a lei logarítmica...
...
As equações ~\ref{freqLinear}, ~\ref{indiceLinear} e ~\ref{serieAmostral} são relativas à progressão linear
...
$n_8=\log_2\frac{f_{\Lambda-q}}{f_0}$ é o número de oitavas entre $f_0$ e $f_{\Lambda-1}$.
...
$a_0=1$ de forma a iniciar a nova sequência com a amplitude original e então ir modificando com o tempo.
