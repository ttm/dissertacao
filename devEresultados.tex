...
Assim, focamos o texto a seguir em Grupos Finitos e Síntese de Estruturas.

Matematicamente, as \emph{simetrias} são descritas por Grupos. Nas artes é de comum conhecimento o papel absolutamente central
...
Embora as aplicações de simetrias neste caso possam se desenvolver
de diversas formas com interesse estético no plano sonoro, em
nossas pesquisas, uma delas se mostrou particularmente coerente
e pertinente: as permutações de unidades sonoras. Primeiro,
através do Teorema de Cayley, todo grupo é isomorfo
...
no núcleo de diversos procedimentos canônicos
