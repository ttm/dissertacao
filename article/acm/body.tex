...
\subsection{Synonymy and polysemy (disclaimer)}
...
We strived to avoid nomenclature clashes and the use of more terms and needed.
Also, some of these issues are exposed when the context is convenient, such as in the discussion of timbre.
...
A fact evidenced by a number of uses this framework had in courses, in software implementations and in making music~\cite{vimeoLM,vivace,repoDissertacao,dissertacao}.
