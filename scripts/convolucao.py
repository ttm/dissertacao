...
ax.annotate(r"$t_{32}'=\sum_{j=0}^9 \, h_j.t_{32-j}$", xy=(32.2, -1.75),  xycoords='data',
...
c=n.convolve(t,h)
p.plot(c-2.5,'go', label=u'sinal convoluído ' + r'$\{\, (t*h)_{i}=\sum_{j=max(i-\Lambda_h,0)}^{i} t_j . h_{i-j}\;\}_{0}^{48+10-2=56}$')
