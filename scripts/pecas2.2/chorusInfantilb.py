...
a.wavwrite(T_i,"chorusInfantilb.wav",f_a) # escrita do som
...
a.wavwrite(T_i,"chorusInfantilb2.wav",f_a) # escrita do som
...
T_i=n.hstack((s+ s1+s2+s3+s4))
T_i=((T_i-T_i.min())/(T_i.max()-T_i.min()))*2-1
a.wavwrite(T_i,"chorusInfantilb3.wav",f_a) # escrita do som
...
s1=v(f=200.*2.**((n.random.random()-0.5)*amb),d=6,fv=n.random.random()*amb_fv,nu=n.random.random()*amb_nu)
s2=v(f=200.*2.**((n.random.random()-0.5)*amb),d=6,fv=n.random.random()*amb_fv,nu=n.random.random()*amb_nu)
s3=v(f=200.*2.**((n.random.random()-0.5)*amb),d=6,fv=n.random.random()*amb_fv,nu=n.random.random()*amb_nu)
s4=v(f=200.*2.**((n.random.random()-0.5)*amb),d=6,fv=n.random.random()*amb_fv,nu=n.random.random()*amb_nu)
...
s1=v(tab=Tr_i,f=200.*2.**((n.random.random()-0.5)*amb),d=6,fv=n.random.random()*amb_fv,nu=n.random.random()*amb_nu)
s2=v(tab=Tr_i,f=200.*2.**((n.random.random()-0.5)*amb),d=6,fv=n.random.random()*amb_fv,nu=n.random.random()*amb_nu)
s3=v(tab=Tr_i,f=200.*2.**((n.random.random()-0.5)*amb),d=6,fv=n.random.random()*amb_fv,nu=n.random.random()*amb_nu)
s4=v(tab=Tr_i,f=200.*2.**((n.random.random()-0.5)*amb),d=6,fv=n.random.random()*amb_fv,nu=n.random.random()*amb_nu)
...
T_i=((T_i-T_i.min())/(T_i.max()-T_i.min()))*2-1
a.wavwrite(T_i,"chorusInfantilb4.wav",f_a) # escrita do som
