...
som=n.hstack((linha1+r(linha2)+l1,linha2+linha3+r(l2),r(linha3)+linha1+l3,r(linha1)+linha2+linha3+l4,linha2+r(l6)))
som=n.hstack((som,r(linha4)+linha2+l1_,r(l2_)+linha6+linha3,l3_+linha4+linha3+linha1,r(l4_)+linha1+linha2+linha3,r(l6_)+r(linha6)+linha2))
...
a.wavwrite(n.hstack((T_i,T_i,T_i,T_i,T_i,T_i)),"ruidosaFaixa3.wav",f_a) # escrita do som
