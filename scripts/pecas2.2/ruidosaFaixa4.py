...
som_e=n.hstack((r(linha2)+l1,linha3+r(l2),linha1+l3,r(linha1)+linha2+linha3,r(l6)))
som_e=n.hstack((som_e,r(linha4)+l1_,r(l2_),l3_+linha3+linha1,r(l4_)+linha1+linha3,r(l6_)+linha2))

som_d=n.hstack((linha1+r(linha2),linha2+linha3,r(linha3)+linha1,linha2+linha3+l4,linha2))
som_d=n.hstack((som_d,r(linha4)+l1_,r(l2_),l3_+linha4+linha1,r(l4_)+linha2+linha3,r(linha6)+linha2))
...
a.wavwrite(n.hstack((T_i,T_i,T_i,T_i,T_i,T_i)).T,"ruidosaFaixa4.wav",f_a) # escrita do som
