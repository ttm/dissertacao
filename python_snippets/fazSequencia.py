...
def fazSequencia(notas, f0, fator, dur_nota, dur_silencio, funcao1, funcao2=0):
    ...
    for nota in notas: # para cada nota
        # a frequência é a fundamental vezes 2 elevado ao número de semitons:
        freq=f0*fator**nota 
        if funcao2: # caso a funcao2 seja especificada, fazer o waveshaping
    ...
    return seq # retorna a sequencia pronta
